...
const statsui = new Stats();
 statsui.showPanel(1); 
 document.body.appendChild(statsui.dom);
console.log(statsui)
/**
 * Base
 */
...
//Galaxy
 ...
 parameters.spin = 1
 parameters.randomness= 0.23
 parameters.randomnessPower = 3
 parameters.insideColor = '#C874B2'
 parameters.outsideColor = '#210535'
...
gui.add(parameters,'radius').min(1).max(15).step(0.1).onChange(generateGalaxy)
